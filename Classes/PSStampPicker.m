...
@interface  PSStampPicker ()
@property (nonatomic) NSMutableArray *buttons;
@end

@interface PSStampPicker (Private)
- (void) buildIndicatorImage;
- (void) configureLayer;
- (void) buildImageButtons;
@end

@implementation PSStampPicker
...
- (id) initWithCoder:(NSCoder *)aDecoder
{
	...
	scrollView_ = [[PSScrollView alloc] initWithFrame:frame];
...
- (CGPoint) contentOffsetForIndex:(NSUInteger)index
{
    ...
    float   newX = PSCenterOfRect([value CGRectValue]).x;
