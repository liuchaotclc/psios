...
@interface PSBarSliderVertical ()
@property (nonatomic) float offset;
@property (nonatomic) BOOL moved;
@end

@implementation PSBarSliderVertical
...
{
    if (!self.overlay) {
        PSBrushSizeOverlay *view = [[PSBrushSizeOverlay alloc] initWithFrame:[self overlayFrame]];
        ...
        self.overlay = view;
        [overlay setPreviewImage:[PSActiveState sharedInstance].brush.generator.bigPreview];
        overlay = view;
