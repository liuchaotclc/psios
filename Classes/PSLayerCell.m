...
- (void) setPaintingLayer:(PSLayer *)layer
{
    paintingLayer = layer;
    ...
    if (blendModeButton) {
        ...
        blendModeButton.hidden = YES;
    }
    if(alphaLockButton){
        alphaLockButton.hidden = YES;
    }
...
- (IBAction) toggleVisibility:(id)sender
{
    ...
    PSLayer *updated = [coder copy:paintingLayer deep:NO];
    [updated toggleVisibility];
    changeDocument(paintingLayer.painting, [PSUpdateLayer updateLayer:updated]);
}
