...
@interface PSStylusManager ()
@property (nonatomic) T1PogoPen *newlyDiscoveredPen;
@end

@implementation PSStylusManager
...
+ (PSStylusManager *) sharedStylusManager
{
    ...
    static PSStylusManager *_stylusManager = nil;
    
    if (!_stylusManager) {
        _stylusManager = [[PSStylusManager alloc] init];
    }
