...
@class PSPaintingFragment;
@class PSXMLElement;

@protocol PSCoder;

@interface PSLayer : NSObject <PSCoding, NSCopying> {
    BOOL                visible_;
    BOOL                locked_;
    BOOL                alphaLocked_;
...
@property (nonatomic, assign) PSBlendMode blendMode;
...
@property (nonatomic, strong) NSMutableArray<PSPath *> *strokePaths;
