...
@implementation PSPaintingFragment
...
{
    return [[PSPaintingFragment alloc] initWithData:data bounds:bounds];
}
...
- (PSPaintingFragment *) inverseFragment:(PSLayer *)layer
{
    ...
    return [PSPaintingFragment paintingFragmentWithData:inverseData bounds:self.bounds];
}
