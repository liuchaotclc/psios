...
@implementation PSCirclesGenerator
...
- (void) drawCircleAtPoint:(CGPoint)center radius:(float)radius width:(float)width inContext:(CGContextRef)ctx randomizer:(PSRandom *)randomizer
{ 
