...
{
    return [[PSGLRegion alloc] initWithContext:context andLayer:layer];
}
...
- (id) initWithContext:(EAGLContext *)inContext andLayer:(CAEAGLLayer *)inLayer
{
    ...
    layer.opaque = NO;
    layer.drawableProperties = @{kEAGLDrawablePropertyRetainedBacking: @(PSCanUseScissorTest()),
