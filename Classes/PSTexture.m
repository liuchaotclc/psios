...
{
    PSTexture *texture = [[PSTexture alloc] initWithCGImage:imageRef forceRGB:YES];
    return texture;
}
...
{
    PSTexture *texture = [[PSTexture alloc] initWithCGImage:imageRef forceRGB:NO];
    return texture;
}
...
@implementation PSTexture (Private)
